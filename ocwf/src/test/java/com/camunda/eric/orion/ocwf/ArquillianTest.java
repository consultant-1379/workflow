package com.camunda.eric.orion.ocwf;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "ocwf";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "ocwf.war")
            ...
            .addPackages(false, "com.camunda.eric.orion.ocwf") // not recursive to skip package 'nonarquillian'
